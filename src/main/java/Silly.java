...
public class Silly implements Comparable<Silly>{
    ...
    /**
     * Creates a new Silly object.
     * This constructor takes two String as the argument.
     *
     * @param first the first part name of this Silly instance.
     * @param second the second part name of this Silly instance.
     */
